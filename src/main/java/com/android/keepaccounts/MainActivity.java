...
import com.android.keepaccounts.utils.Utility;
import com.android.keepaccounts.view.GradeProgressView;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //总收入
        findViewById(R.id.month_total_income_layout).setOnClickListener(this);
        //总支出
        findViewById(R.id.month_total_expense_layout).setOnClickListener(this);
        initSettings();
        initView();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.show_today_text:
                ...
                setContentData();
                break;
            case R.id.month_total_income_layout:
                Intent income = new Intent(MainActivity.this, TotalIncomeActivity.class);
                startActivity(income);
                break;
            case R.id.month_total_expense_layout:
                Intent expense = new Intent(MainActivity.this, TotalExpenseActivity.class);
